...
def tech_specs_screen():
    data = {
        ...
        "Resolution": "4K Ultra HD 4096 x 2304p",
        "Screen features": "- 500 nits brightness\n- Wide colour (P3)",
        "WiFi": "AC WiFi",
        ...
        "Dimensions": "450 x 528 x 175 mm (H x W x D)",
        "Weight": "5.60 kg",
...
def tech_specs_no_screen():
    data = {
        ...
        "Audio connections": "3.5 mm jack x 2",
        "Audio software": "Waves MaxxAudio Pro",
        "Disc drive": "DVD",
        "Memory card reader": "SD",
        "Mouse / trackpad": "USB mouse",
        "Keyboard": "USB keyboard with numeric keypad",
        "Security features": "- Padlock ring security lock slot\n- Security cable wedge-shaped lock slot",
        "Colour": "Black",
        "Box contents": "- Dell Inspiron 3881 Desktop PC (348P9)\n- Power adapter\n- Documentation",
        "Dimensions": "324.3 x 154 x 293 mm (H x W x D)",
        "Weight": "6.4 kg",
        "Manufacturer’s guarantee": "1 year",
