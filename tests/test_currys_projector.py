...
def test_parse_scrape_url(products):
    ...
    assert res == "https://www.currys.co.uk/gbuk/computing/projectors/projectors/optoma-gt1080e-full-hd-home-cinema-projector-10215801-pdt.html"
    res = clp._parse_scrape_url(products[5])
    assert res == "https://www.currys.co.uk/gbuk/computing/projectors/projectors/epson-eh-tw740-full-hd-home-cinema-projector-10218973-pdt.html"
...
@pytest.fixture
def tech_specs():
    data = {'Type': 'Home cinema projector', 'Resolution': '1920 x 1080', 'Technology': 'DLP', 'Projection type': 'Short throw', 'Screen size range': '45.3" - 300"', 'Projection range': '- 300" at 3.35 m\n- 45.3" at 0.5 m', 'Video standard': '- NTSC\n- SECAM\n- PAL', 'Brightness': '3000 lumens', 'Aspect ratio': '16:9', 'Contrast ratio': '25000:1', 'Keystone correction': 'Yes', '3D ready': 'Yes', 'Other features': '- BrilliantColor\n- ISFccc\n- Game mode\n- ProJect Green\n- Security lock slot (cable lock sold separately)\n- Password protection\n- Security bar', 'Number of speakers': '1', 'Audio power': '10 W', 'Wireless connectivity': 'WiFi via adapter (sold separately)', 'Video interface': '- HDMI x 2\n- MHL x 1', 'USB': 'Mini-USB Type B x 1', 'Audio interface': '3.5 mm jack x 1', 'Energy consumption': '233 W', 'Lamp type and consumption': '190 W', 'Lamp life': '5000 hours', 'Energy saving features': 'Eco mode', 'Colour': 'White', 'Box contents': '- Optoma GT1080e Full HD Home Cinema Projector\n- Carrying case\n- Lens cover\n- AAA batteries x 2\n- Wireless remote control', 'Dimensions': '114 x 315 x 224 mm (H x W x D)', 'Weight': '2.65 kg', 'Manufacturer’s guarantee': '1 year'}
    return data
